...
const uint32_t CRYPTONOTE_MAX_BLOCK_NUMBER                   = 256000000;
const size_t   CRYPTONOTE_MAX_BLOCK_BLOB_SIZE                = 500000000;
const size_t   CRYPTONOTE_MAX_TX_SIZE                        = 1000000000;
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 7757; //bL as prefix
const uint32_t CRYPTONOTE_MINED_MONEY_UNLOCK_WINDOW          = 10;
const uint64_t CRYPTONOTE_BLOCK_FUTURE_TIME_LIMIT            = 60 * 45; // 45 mins as maximum blocktime when spiking up in diff
const uint64_t CRYPTONOTE_BLOCK_FUTURE_TIME_LIMIT_V3         = 2.5 * DIFFICULTY_TARGET; // Dampening the spikes of diff
const uint64_t CRYPTONOTE_BLOCK_FUTURE_TIME_LIMIT_V4         = 5 * DIFFICULTY_TARGET; // Dampening the spikes of diff
...
*/
const char     GENESIS_COINBASE_TX_HEX[]                     = "010a01ff00010002dc6a6a3128a4e6d5fa3ea20fd064e5cda9baa74ad18bc3b24d1978b719334d552101f3a5895b4cc4a18cf39bf3acbcb6ce4fae04b7d755103e131a36ce7854b0d75b";
...
const size_t   CRYPTONOTE_BLOCK_GRANTED_FULL_REWARD_ZONE     = 131071; //size of block (bytes) after which reward for block calculated using block size
const size_t   CRYPTONOTE_BLOCK_GRANTED_FULL_REWARD_ZONE_V2  = 262142;
const size_t   CRYPTONOTE_BLOCK_GRANTED_FULL_REWARD_ZONE_V1  = 131071;
const size_t   CRYPTONOTE_BLOCK_GRANTED_FULL_REWARD_ZONE_CURRENT = CRYPTONOTE_BLOCK_GRANTED_FULL_REWARD_ZONE;
const size_t   CRYPTONOTE_COINBASE_BLOB_RESERVED_SIZE        = 600;

const size_t   CRYPTONOTE_DISPLAY_DECIMAL_POINT              = 7;

const uint64_t MINIMUM_FEE                                   = UINT64_C(50000); // 0.0500000 BLG
...
const uint32_t MIXIN_LIMITS_V2_HEIGHT                        = 30000;
...
const uint32_t UPGRADE_HEIGHT_V4                             = 15;     // Upgrade height for CN-Lite Variant 1 switch.
const uint32_t UPGRADE_HEIGHT_V5                             = 1500;   // Upgrade height for CN-Turtle Variant 2 switch.
...
const char     CRYPTONOTE_NAME[]                             = "BlogCoin";
...
const uint32_t P2P_DEFAULT_PACKET_MAX_SIZE                   = 51200000;      // 51200000 bytes maximum packet size
...
const char* const SEED_NODES[] = {
    "5.172.219.174:54212", // sniperviperman
    "99.248.93.15:54212"   // def
};
} // CryptoNote
